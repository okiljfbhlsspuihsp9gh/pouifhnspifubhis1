...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/apoufhp9asiufgapiufg/pifhnjas-fn-aso/master/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "basicBot",
        loggedInID: null,
        scriptLink: "https://rawgit.com/okiljfbhlsspuihsp9gh/pouifhnspifubhis2/master/bot.js",
        scriptLink2: "https://rawgit.com/okiljfbhlsspuihsp9gh/pouifhnspifubhis3/master/aw.js",
        cmdLink: "http://bit.ly/usercmd",
        cmdLink2: "http://bit.ly/staffcmd",
        chatLink: "https://rawgit.com/apoufhp9asiufgapiufg/pifhnjas-fn-aso/master/normalan.json",
        chat: null,
        loadChat: loadChat,
        ...
        eventDjadvance: function (obj) {
            ...
            if (basicBot.settings.autoskip) {
                ...
                basicBot.room.autoskipTimer = setTimeout(function() {
                    ...
                    if (startcid === endcid) {
                        API.sendChat(basicBot.chat.stuck);
                        API.moderateForceSkip();
                    }
                }, remaining + 5000);
            }
        ...
        chatUtilities: {
            chatFilter: function (chat) {
                ...
                if(msg.indexOf("@ST ARMY BOT volim te") !== -1 || msg.indexOf("@ST ARMY BOT Ljubavi") !== -1 || msg.indexOf("@ST ARMY BOT ljubavi") !== -1 || msg.indexOf("@ST ARMY BOT :heart:") !== -1 || msg.indexOf("@ST ARMY BOT <3") !== -1 || msg.indexOf("@ST ARMY BOT :<3:") !== -1 || msg.indexOf("@ST ARMY BOT Volim te") !== -1 || msg.indexOf("@ST ARMY BOT Volim Te") !== -1 || msg.indexOf("@ST ARMY BOT i love you") !== -1 || msg.indexOf("@ST ARMY BOT I love you") !== -1 || msg.indexOf("@ST ARMY BOT love you") !== -1 || msg.indexOf("@ST ARMY BOT Love you") !== -1 || msg.indexOf("@ST ARMY BOT Love You") !== -1){                
                ...
                if(msg.indexOf("xspšhigišsghisšg") !== -1 || msg.indexOf("Slack(pozivnica) - http://bit.ly/slack-i :yum: Slack(login) - http://bit.ly/slack-l :gem:") !== -1 || msg.indexOf("soifhsopufghspoufhus") !== -1){                
                 setTimeout(function (id) {
                        API.moderateDeleteChat(id);
                    }, 80 * 1000, chat.cid);
                }
                if(msg.indexOf("@undefined") !== -1 || msg.indexOf("sšifhjs0ifhsšf") !== -1 || msg.indexOf("(function(){$.getScript(") !== -1 || msg.indexOf("stg.plug.dj/") !== -1 || msg.indexOf("plug.dj/") !== -1 || msg.indexOf("https://stg.plug.dj/") !== -1 || msg.indexOf("https:// stg.plug.dj/") !== -1 || msg.indexOf("!refresh") !== -1 || msg.indexOf("!rf") !== -1 || msg.indexOf("!watermelons") !== -1 || msg.indexOf("!fire") !== -1 || msg.indexOf("so0ifh0jšsihšs") !== -1 || msg.indexOf("foinčćšfsfouisf") !== -1 || msg.indexOf("undefined") !== -1){
                 API.moderateDeleteChat(chat.cid);  
                }
                if(msg.indexOf("oivhjdsšijsšifjs") !== -1 || msg.indexOf("@djs rulet je pokrenut! (kucajte !join da učestvujete!)") !== -1){                
                 setTimeout(function (id) {
                        API.moderateDeleteChat(id);
                 }, 30 * 1000, chat.cid);
                }
        ...
        commands: {
            ...
            inactiverCommand: {
                ...
                functionality: function (chat, cmd){
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                           ...
                           var msg = chat.message;
                           var argument = msg.substr(cmd.length+1);
                           if (argument == 'reset'){
                           var msg = chat.message;
                           if (msg.length === cmd.length) return API.sendChat(subChat(basicBot.chat.nouserspecified, {name: chat.un}));
            ...
            meowCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                            ...
                            var randomMeow = Math.floor(Math.random() * basicBot.chat.meows.length);
                            var randomSentence = Math.floor(Math.random() * 1);
                            API.sendChat(subChat(basicBot.chat.meow, {name: chat.un, botname: basicBot.settings.botName, response: basicBot.chat.meows[randomMeow]}));
                     }
                }
            },
            ...
            wastedCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                            ...
                            var msg = chat.message;
                            var randomUser = Math.floor(Math.random() * crowd.length);
                            var randomWasted = Math.floor(Math.random() * basicBot.chat.wasteds.length);
                            var randomSentence = Math.floor(Math.random() * 1);
                            API.sendChat(subChat(basicBot.chat.wasted, {name: chat.un, botname: basicBot.settings.botName, response: basicBot.chat.wasteds[randomWasted]}));
                     }
                }
            },
            ...
            staffcmdCommand: {
                ...
                functionality: function (chat, cmd){
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                           ...
                           var argument = msg.substr(cmd.length+1);
                           if (argument == 'cmd'){
                           API.sendChat(subChat(basicBot.chat.commandslink, {name: chat.un, link: basicBot.cmdLink2}));
                       }
                   }
               }
           },
            ...
            loveCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var space = msg.indexOf(' ');
                        if (space === -1) {
                            API.sendChat(basicBot.chat.selflove);
                            return false;
                        }
                        else {
                            var name = msg.substring(space + 2);
                            ...
                            if (user === false || !user.inRoom) {
                                ...
                                return API.sendChat(subChat(basicBot.chat.love, {nameto: user.username, namefrom: chat.un, loves: this.getLove()}));
                            }
                        }
                    }
                }
            ...
            flirtCommand: {
                ...
                rank: 'user',
                type: 'startsWith',
                getFlirt: function (chat) {
                    var c = Math.floor(Math.random() * basicBot.chat.flirts.length);
                    return basicBot.chat.flirts[c];
                },
                functionality: function (chat, cmd) {
                    if (this.type === 'exact' && chat.message.length !== cmd.length) return void (0);
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var space = msg.indexOf(' ');
                        if (space === -1) {
                            API.sendChat(basicBot.chat.noflirt);
                            return false;
                        }
                        else {
                            var name = msg.substring(space + 2);
                            ...
                            if (user === false || !user.inRoom) {
                                ...
                                return API.sendChat(subChat(basicBot.chat.flirt, {nameto: user.username, namefrom: chat.un, flirts: this.getFlirt()}));
                            }
                        }
                    }
                }
            ...
            emojiCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var link = 'http://bit.ly/plug-emoji';
                        API.sendChat(subChat(basicBot.chat.emojilist, {link: link}));
                    }
                }
            },

            /*urules(neuspeli pokusaj)Command: {
                command: 'rul',
                rank: 'residentdj',
                type: 'startsWith',
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var ch = '@' + name + basicBot.chat.rulesaler1;
                        switch(lang){}
                        ch += ' molim te, pročitaj pravila - http://bit.ly/rules-sr ';
                        API.sendChat(basicBot.chat.rulesaler1);
                    }
                }
            },*/
            ...
            /*rulessrCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var space = msg.indexOf(' ');
                        if (space === -1) {
                            API.sendChat(subChat(basicBot.chat.nouserspecified, {name: name}));
                            return false;
                        }
                        else {
                            var name = msg.substring(space + 2);
                            var user = basicBot.userUtilities.lookupUserName(name);
                            if (user === false || !user.inRoom) {
                                return API.sendChat(subChat(basicBot.chat.usernotfound, {name: name}));
                            }
                            else if (user.username === chat.un) {
                                return API.sendChat(subChat(basicBot.chat.selfrules, {name: name}));
                            }
                            else {
                                return API.sendChat(subChat(basicBot.chat.rulesssr, {nameto: user.username, namefrom: chat.un, cookie: this.getRules()}));
                            }
                        }
                    }
                }
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (space === -1) {
                            ...
                            if (user === false || !user.inRoom) {
                                ...
                                return API.sendChat(subChat(basicBot.chat.rulessen, {nameto: user.username, namefrom: chat.un, cookie: this.getRulesen()}));
                            }
                        }
                    }
                }
            ...
            /*enurules(neuspeli pokusaj)Command: {
                command: 'en',
                rank: 'residentdj',
                type: 'startsWith',
                functionality: function (chat, cmd){
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                           ...
                           if(typeof user === 'boolean') return API.sendChat(subChat(basicBot.chat.invaliduserspecified, {name: chat.un}));
                           var lang = basicBot.userUtilities.getUser(user).language;
                           var ch = '@' + name + basicBot.chat.rulesaler2;
                           switch(lang){}
                           ch += ' please, read the rules - http://bit.ly/rules-en ';
                           API.sendChat(basicBot.chat.rulesaler2);
                       }
                   }
               }
           },*/

            /*enurules(prva komanda)Command: {
                command: 'enrul',
                rank: 'residentdj',
                type: 'startsWith',
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        var ch = '@' + name + ' ';
                        switch(lang){}
                        ch += ' please read the rules - https://goo.gl/2aTRhs';
                        API.sendChat(ch);
                    }
                }
            },*/
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (!isNaN(time)) {
                            ...
                            if (time > 24 * 60 * 60) API.moderateBanUser(user.id, 5, API.BAN.PERMA);
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                      ...
                      if (basicBot.settings.thorCommand){
                        var id = chat.uid,
                              ...
                              thorCd = false,
                              timeInMinutes = 0,
                              worthyAlg = Math.floor((Math.random() * API.getWaitList().length) + 1);
            ...
            slackinfoCommand: {
                ...
                functionality: function (chat, cmd){
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                           ...
                           var argument = msg.substr(cmd.length+1);
                           if (argument == 'slack'){
                           API.sendChat(basicBot.chat.slackinfo)
                       }
                   }
               }
           },
           ...
           slackdinfoCommand: {
                ...
                functionality: function (chat, cmd){
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                           ...
                           API.sendChat(basicBot.chat.slackd)
                       }
                   }
               }
           },
            ...
            nolagCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.nolag)
                    }
                }
            },
            ...
            botinfoCommand: {
                ...
                functionality: function (chat, cmd){
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                           ...
                           var argument = msg.substr(cmd.length+1);
                           if (argument == 'bot'){
                           API.sendChat(basicBot.chat.botinfo)
                       }
                   }
               }
           },
            ...
            staffloveCommand: {
                ...
                functionality: function (chat, cmd){
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                           ...
                           var argument = msg.substr(cmd.length+1);
                           if (argument == 'love'){
                           API.sendChat(basicBot.chat.stafflove)
                       }
                   }
               }
           },
            ...
            stginforCommand: {
                ...
                functionality: function (chat, cmd){
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                           ...
                           var argument = msg.substr(cmd.length+1);
                           if (argument == 'stg'){
                           API.sendChat(basicBot.chat.stginfo)
                       }
                   }
               }
           },
            ...
            test0rCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.test)
                    }
                }
            },
            ...
            capsoffCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.caps)
                    }
                }
            },
            ...
            slackCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.slack)
                    }
                }
            },
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (basicBot.settings.songstats) {
                            ...
                            return API.sendChat(subChat(basicBot.chat.toggleoff2, {name: chat.un, 'function': basicBot.chat.songstats}));
                        }
                        else {
                            basicBot.settings.songstats = !basicBot.settings.songstats;
                            return API.sendChat(subChat(basicBot.chat.toggleon2, {name: chat.un, 'function': basicBot.chat.songstats}));
                        }
                    }
                }
            },
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (basicBot.settings.motdEnabled) {
                            ...
                            API.sendChat(subChat(basicBot.chat.toggleoff2, {name: chat.un, 'function': basicBot.chat.motd}));
                        }
                        else {
                            basicBot.settings.motdEnabled = !basicBot.settings.motdEnabled;
                            API.sendChat(subChat(basicBot.chat.toggleon2, {name: chat.un, 'function': basicBot.chat.motd}));
                        }
                    }
                }
            },
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        $.getJSON('/_/bans', function (json){
                            ...
                            if (!found) return API.sendChat(subChat(basicBot.chat.notbanned, {name: chat.un, username: name}));
                            API.moderateUnbanUser(bannedUser.id);
                            API.sendChat(subChat(basicBot.chat.unbanned, {name: chat.un, username: name}));
                        });
                    }
                }
            },
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        $.getJSON('/_/mutes', function (json){
                            ...
                            if (msg.indexOf('@') === -1 && arg === 'all'){
                                ...
                                if (!found) return API.sendChat(subChat(basicBot.chat.unmuted, {name: chat.un}));
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (basicBot.settings.usercommandsEnabled) {
                            API.sendChat(subChat(basicBot.chat.toggleoff3, {name: chat.un, 'function': basicBot.chat.usercommands}));
                            basicBot.settings.usercommandsEnabled = !basicBot.settings.usercommandsEnabled;
                        }
                        else {
                            API.sendChat(subChat(basicBot.chat.toggleon3, {name: chat.un, 'function': basicBot.chat.usercommands}));
                            basicBot.settings.usercommandsEnabled = !basicBot.settings.usercommandsEnabled;
                        }
                    }
                }
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (basicBot.settings.welcome) {
                            ...
                            return API.sendChat(subChat(basicBot.chat.toggleoff2, {name: chat.un, 'function': basicBot.chat.welcomemsg}));
                        }
                        else {
                            basicBot.settings.welcome = !basicBot.settings.welcome;
                            return API.sendChat(subChat(basicBot.chat.toggleon2, {name: chat.un, 'function': basicBot.chat.welcomemsg}));
                        }
                    }
                }
            },
